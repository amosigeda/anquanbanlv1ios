...
- (IBAction)saveBtn:(id)sender {
    ...
    WebServiceParameter *parameter5 = [WebServiceParameter newWithKey:@"homeAddress" andValue:model.HomeAddress];
    WebServiceParameter *parameter6 = [WebServiceParameter newWithKey:@"homeLat" andValue:model.HomeLat];
    WebServiceParameter *parameter7 = [WebServiceParameter newWithKey:@"homeLng" andValue:model.HomeLng];
    WebServiceParameter *parameter8 = [WebServiceParameter newWithKey:@"schoolAddress" andValue:[defaults objectForKey:@"schoolAddress"]];
    WebServiceParameter *parameter9 = [WebServiceParameter newWithKey:@"schoolLat" andValue:[defaults objectForKey:@"school_coordinate_latitude"]];
    WebServiceParameter *parameter10 = [WebServiceParameter newWithKey:@"schoolLng" andValue:[defaults objectForKey:@"school_coordinate_longitude"]];
        ...
        if(placemarks.count > 0){
            for (CLPlacemark *placemark in placemarks) {
                ...
                if(addstring.length == 0){
                    ...
                    self.addressLabel.text = addstring;
                    [defaults setObject:addstring forKey:@"schoolAddress"];
                    [defaults setDouble:latitude.doubleValue forKey:@"school_coordinate_latitude"];
                    [defaults setDouble:longitude.doubleValue forKey:@"school_coordinate_longitude"];
                }
                break;
            }
        }else{
            self.addressLabel.text = @"无法查找地址";
        }
    }];
}
